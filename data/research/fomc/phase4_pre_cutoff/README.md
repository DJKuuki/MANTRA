...
- **Temporal Window**: `2015-01-28T19:00:00Z` to `2020-01-01T19:00:00Z`
- **Earliest Contamination Timestamp**: `2020-01-29T19:00:00Z`
- **Temporal Separation Buffer**: Strict 28-day future isolation buffer between the latest pre-cutoff document and earliest post-cutoff contamination document.

## 3. Corpus Composition
- **Total Documents**: 64 official Federal Reserve documents
  - `scheduled_statement`: 40 scheduled FOMC monetary policy statements (2015–2019)
  - `meeting_minutes`: 24 official FOMC meeting minutes (2017–2019)
- **Total Words**: 251,649 words
- **Estimated Subword Tokens**: ~327,143 tokens (> 256,000 required budget)
- **D0 Repetition Feasibility**: Repetition ratio = 0.00 <= 0.20 (no shortfall).
