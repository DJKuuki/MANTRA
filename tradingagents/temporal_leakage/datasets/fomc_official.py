...
def load_fomc_official_statements(
    ...
    Returns:
        List of strictly validated TemporalSample instances with availability_quality='exact'.
    """
    if filepath is not None:
        ...
        # Reference verified official statement subset with certified exact timestamps
        raw_statements = [
            {
                "sample_id": "fed-official-2018-03",
                ...
                "annotation_source": "FOMC_OFFICIAL_RECORD",
                ...
                "metadata": {"chair": "Powell", "vote": "unanimous"},
            },
            {
                "sample_id": "fed-official-2018-06",
            ...
            {
                "sample_id": "fed-official-2019-07",
                ...
                "metadata": {"chair": "Powell", "vote": "8-2"},
            },
            {
                "sample_id": "fed-official-2022-03",
                ...
                "metadata": {"chair": "Powell", "vote": "8-1"},
            },
        ]
        samples = [
            TemporalSample(
...
def create_fomc_official_benchmark(
    ...
    """Instantiate an FOMCBenchmark using official statements with verified exact PIT timestamps.

    For verified official statements, `is_formal_research_ready()` evaluates to True.
    """
